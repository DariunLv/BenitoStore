  ...
  return (
    <div className="main-content">
      ...
      <div style={{
        ...
        {/* Background photo - clearly visible */}
        {hasImage && (
          <motion.img
            src={category.image}
            alt={category.name}
        ...
        {/* Light bottom gradient only - so text is readable */}
        <div style={{
        ...
        {/* Decorative corners */}
        <div style={{
          position: 'absolute', top: 14, right: 14, zIndex: 2, width: 24, height: 24,
          borderTop: '2px solid rgba(247,103,7,0.3)', borderRight: '2px solid rgba(247,103,7,0.3)',
          borderRadius: '0 6px 0 0',
        }} />
        <div style={{
          position: 'absolute', bottom: 14, left: 14, zIndex: 2, width: 24, height: 24,
          borderBottom: '2px solid rgba(247,103,7,0.3)', borderLeft: '2px solid rgba(247,103,7,0.3)',
